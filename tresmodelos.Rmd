...
De donde el error del clasificador de Bayes es `r bayes_error`.
...
```{r,  fig.height=7, fig.width=8, fig.align='center'}
plot_errores + geom_abline(slope=0, intercept=bayes_error, color="red", linetype="dashed", alpha=0.6) + annotate("text", x=100, y=bayes_error+0.006, label="Error óptimo de Bayes", size=4)
```
