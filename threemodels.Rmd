...
* Blue: first, we generate ten points $b_k$ ($k=1,2,\ldots,10$) from a bivariate Normal distribution $N((1,0)^{T}, \mathbf{I})$ (where $\mathbf$ is the identity $2\times 2$ matrix). These will be the centroids of our blue population. In order to generate a blue point we choose $k$ at random and generate one point from $N(b_k, \mathbf{I}/5)$.
